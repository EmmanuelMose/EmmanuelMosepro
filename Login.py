...
def register():
    ...
    resize_and_center(register_window, 400, 300)

    frame = tk.Frame(register_window, bg="light blue", padx=20, pady=20)
    frame.pack(fill="both", expand=True)

    label_font = ("TkDefaultFont", 12)
    entry_font = ("TkDefaultFont", 12)

    tk.Label(frame, text="Username:", bg="light blue", fg="blue", font=label_font).grid(row=0, column=0, padx=10, pady=5, sticky="w")
    reg_username_entry = tk.Entry(frame, font=entry_font)
    reg_username_entry.grid(row=0, column=1, padx=10, pady=5, sticky="ew")

    tk.Label(frame, text="Password:", bg="light blue", fg="blue", font=label_font).grid(row=1, column=0, padx=10, pady=5, sticky="w")
    reg_password_entry = tk.Entry(frame, show="*", font=entry_font)
    reg_password_entry.grid(row=1, column=1, padx=10, pady=5, sticky="ew")

    tk.Label(frame, text="Confirm Password:", bg="light blue", fg="blue", font=label_font).grid(row=2, column=0, padx=10, pady=5, sticky="w")
    reg_confirm_password_entry = tk.Entry(frame, show="*", font=entry_font)
    reg_confirm_password_entry.grid(row=2, column=1, padx=10, pady=5, sticky="ew")
    ...
    tk.Button(frame, text="Register", command=register_user, bg="green", fg="white", font=label_font).grid(row=3, column=0, columnspan=2, pady=10)

    login_frame = tk.Frame(register_window, bg="light blue", padx=10, pady=10)
    login_frame.pack()
...
def admin_window():
    ...
    resize_and_center(admin, 400, 300)
    label_font = ("TkDefaultFont", 12)
...
def student_window():
    ...
    resize_and_center(student, 400, 300)
    label_font = ("TkDefaultFont", 12)
...
resize_and_center(root, 350, 300)  # Increased height

top_frame = tk.Frame(root, bg="blue", height=50)
top_frame.pack(fill="x")

title_label = tk.Label(top_frame, text="Login Page", bg="blue", fg="white", font=("TkDefaultFont", 16))
title_label.pack(pady=10, fill="x") # Added fill="x"

content_frame = tk.Frame(root, bg="light blue", padx=20, pady=10)
...
admin_radio.grid(row=2, column=0, sticky="w", padx=5, pady=5)
...
student_radio.grid(row=2, column=1, sticky="w", padx=5, pady=5)
